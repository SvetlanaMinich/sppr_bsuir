...
namespace WEB_253503_MINICH.UI.Services.Authorization
{
    ...
    public class KeycloakAuthService : IAuthService
    {
        ...
        public KeycloakAuthService(IHttpClientFactory httpClientFactory, 
        ...
        public async Task<(bool Result, string ErrorMessage)> RegisterUserAsync(string email, 
                                                                                string password, 
                                                                                IFormFile? avatar)
        {
