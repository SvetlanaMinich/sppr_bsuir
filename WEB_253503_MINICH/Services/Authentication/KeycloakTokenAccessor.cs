...
namespace WEB_253503_MINICH.UI.Services.Authentication
{
    public class KeycloakTokenAccessor : ITokenAccessor
    {
        ...
        public KeycloakTokenAccessor(IOptions<KeycloakData> options, IHttpContextAccessor httpContextAccessor, IHttpClientFactory httpClientFactory)
        {
